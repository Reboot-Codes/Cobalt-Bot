import { createCommand, humanizeMilliseconds, sendEmbed } from '../utils/helpers.ts';
  ...
  execute: (message) => {
    ...
    sendEmbed(message.channelId, {
      ...
      fields: [
        {
          "name": "About This Bot",
          "value": "Hey there, I'm a Bot built in Deno that strives to be the best!\nIf you don't know my prefix for your server, try to ping me!\n\nhttps://cobalt.reboot.dev/"
        },
        {
          "name": "Created By",
        ...
        },
        {
          ...
          "value": "https://cobalt.reboot.dev/support",
          "inline": true
        },
        {
          "name": "Invite",
          "value": "https://cobalt.reboot.dev/invite",
          "inline": true
        },
        {
          "name": "Active Guilds",
